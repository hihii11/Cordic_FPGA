...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "par_num" -parent ${Page_0}
...
proc update_PARAM_VALUE.par_num { PARAM_VALUE.par_num } {
	# Procedure called to update par_num when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.par_num { PARAM_VALUE.par_num } {
	# Procedure called to validate par_num
	return true
}
...
proc update_MODELPARAM_VALUE.par_num { MODELPARAM_VALUE.par_num PARAM_VALUE.par_num } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.par_num}] ${MODELPARAM_VALUE.par_num}
}
