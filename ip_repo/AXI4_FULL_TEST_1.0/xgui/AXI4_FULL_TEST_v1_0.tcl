...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Base address of targeted slave} ${C_M0_AXI_TARGET_SLAVE_BASE_ADDR}
  set C_M0_AXI_BURST_LEN [ipgui::add_param $IPINST -name "C_M0_AXI_BURST_LEN" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Burst Length. Supports 1, 2, 4, 8, 16, 32, 64, 128, 256 burst lengths} ${C_M0_AXI_BURST_LEN}
  ...
  set C_M0_AXI_AWUSER_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXI_AWUSER_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of User Write Address Bus} ${C_M0_AXI_AWUSER_WIDTH}
  set C_M0_AXI_ARUSER_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXI_ARUSER_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of User Read Address Bus} ${C_M0_AXI_ARUSER_WIDTH}
  set C_M0_AXI_WUSER_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXI_WUSER_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of User Write Data Bus} ${C_M0_AXI_WUSER_WIDTH}
  set C_M0_AXI_RUSER_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXI_RUSER_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of User Read Data Bus} ${C_M0_AXI_RUSER_WIDTH}
  set C_M0_AXI_BUSER_WIDTH [ipgui::add_param $IPINST -name "C_M0_AXI_BUSER_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of User Response Bus} ${C_M0_AXI_BUSER_WIDTH}
...
proc update_PARAM_VALUE.C_M0_AXI_BURST_LEN { PARAM_VALUE.C_M0_AXI_BURST_LEN } {
	# Procedure called to update C_M0_AXI_BURST_LEN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M0_AXI_BURST_LEN { PARAM_VALUE.C_M0_AXI_BURST_LEN } {
	# Procedure called to validate C_M0_AXI_BURST_LEN
	return true
}
...
proc update_MODELPARAM_VALUE.C_M0_AXI_BURST_LEN { MODELPARAM_VALUE.C_M0_AXI_BURST_LEN PARAM_VALUE.C_M0_AXI_BURST_LEN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M0_AXI_BURST_LEN}] ${MODELPARAM_VALUE.C_M0_AXI_BURST_LEN}
}
