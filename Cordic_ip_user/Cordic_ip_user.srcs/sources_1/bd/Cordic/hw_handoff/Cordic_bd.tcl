...
################################################################
# This is a generated script based on design: Cordic
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Roate_keyv2_0, and set properties
  set Roate_keyv2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Roate_keyv2:1.0 Roate_keyv2_0 ]

  # Create instance: cordic_0, and set properties
  set cordic_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cordic:1.0 cordic_0 ]

  # Create instance: key_shake_0, and set properties
  set key_shake_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:key_shake:1.0 key_shake_0 ]
  set_property -dict [ list \
   CONFIG.clk_delay {100} \
 ] $key_shake_0

  # Create instance: key_shake_1, and set properties
  set key_shake_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:key_shake:1.0 key_shake_1 ]
  set_property -dict [ list \
   CONFIG.clk_delay {100} \
 ] $key_shake_1

  # Create instance: key_shake_2, and set properties
  set key_shake_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:key_shake:1.0 key_shake_2 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {D:/Vivado/ZYBO_zynq.xml} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins cordic_0/S0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Roate_keyv2_0/S0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net key_1 [get_bd_ports SW] [get_bd_pins key_shake_0/key]
  connect_bd_net -net key_1_1 [get_bd_ports B] [get_bd_pins key_shake_2/key]
  connect_bd_net -net key_2_1 [get_bd_ports A] [get_bd_pins key_shake_1/key]
  connect_bd_net -net key_shake_0_key_out [get_bd_pins Roate_keyv2_0/SW] [get_bd_pins key_shake_0/key_out]
  connect_bd_net -net key_shake_1_key_out [get_bd_pins Roate_keyv2_0/A_pin] [get_bd_pins key_shake_1/key_out]
  connect_bd_net -net key_shake_2_key_out [get_bd_pins Roate_keyv2_0/B_pin] [get_bd_pins key_shake_2/key_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodOLED_0/s_axi_aclk] [get_bd_pins Roate_keyv2_0/s0_axi_aclk] [get_bd_pins cordic_0/s0_axi_aclk] [get_bd_pins key_shake_0/clk] [get_bd_pins key_shake_1/clk] [get_bd_pins key_shake_2/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PmodOLED_0/s_axi_aresetn] [get_bd_pins Roate_keyv2_0/s0_axi_aresetn] [get_bd_pins cordic_0/s0_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins key_shake_0/rst] [get_bd_pins key_shake_1/rst] [get_bd_pins key_shake_2/rst] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Roate_keyv2_0/S0_AXI/S0_AXI_reg] SEG_Roate_keyv2_0_S0_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cordic_0/S0_AXI/S0_AXI_reg] SEG_cordic_0_S0_AXI_reg
