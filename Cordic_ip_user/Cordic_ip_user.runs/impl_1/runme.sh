...
HD_PWD='D:/Vivado/project/Cordic_ip_user/Cordic_ip_user.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cordic_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cordic_wrapper.tcl -notrace
