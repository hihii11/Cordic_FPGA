...
HD_PWD='D:/Vivado/project/Cordic_ip_user/Cordic_ip_user.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cordic_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cordic_wrapper.tcl
